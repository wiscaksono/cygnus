...
interface IConfirmationModal extends IDeleteAll {
  isOpen: boolean;
  closeModal: () => void;
}
                  ...
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      <Dialog.Title as="h3" className="text-base font-semibold leading-6 text-gray-900">
                        Hapus semua data pelamar
                      </Dialog.Title>
                      <div className="mt-2">
                        <p className="text-sm text-gray-500">
                          Apakah anda yakin ingin menghapus semua data pelamar yang dipilih? semua data yang telah dihapus tidak dapat dikembalikan.
                        </p>
                      </div>
                    </div>
                  </div>
