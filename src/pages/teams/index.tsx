  ...
  return (
    <>
      ...
      <ul role="list" className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
        {teams.map((team) => (
          <li key={team.id}>
            <Image width={300} height={200} className="aspect-[3/2] w-full rounded-2xl object-cover" src={team.image} alt={team.fullName} />
            <h3 className="mt-6 text-lg font-semibold leading-8 tracking-tight text-gray-900">{team.fullName}</h3>
